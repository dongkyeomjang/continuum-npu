...
1. **GPU(A6000) 교차검증** — [결정 4](#결정-4--gpua6000-교차검증-착수-시점)의 착수 조건이 충족됐다. Advisor의 지시문 발행 전까지 GPU 서버 관련 작업을 시작하지 않는다.
2. online 정책 설계와 [TASK26](TASK26.md) offline 상한 대비 손실 측정.
